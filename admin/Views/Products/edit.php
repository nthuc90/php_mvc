                ...
                <section>
                    <nav class="show-admin">
                        ...
                        <form action="" method="post"  enctype="multipart/form-data">
                            ...
                            <div>
                                <label for="">Ảnh</label>
                                <input type="file" class="form-control" name="image" value="<?php echo ($pr['image']) ?>">
                            </div>
                            <div>
                                <label for="">Giá</label>
                                <input type="number" class="form-control" name="price" value="<?php echo ($pr['price']) ?>">
                            </div>
                            <div>
                                <label for="">Mô tả</label>
                                <input type="text" class="form-control" name="short_desc" value="<?php echo ($pr['short_desc']) ?>">
                            </div>
                            <div>
                                <input type="submit" name="editSubmit" value="Sửa" class="btn btn-primary">
                                <a href="?page=product&action=listProduct" class="btn btn-danger">Hủy</a>
                            </div>
                        </form>
                    </nav>
                </section>
